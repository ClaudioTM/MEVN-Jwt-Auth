<template>
  <div id="food">
    <h1 class="subtitle has-text-centered">Food Items List:</h1>
    <hr />
...
export default {
  ...
  methods: {
    ...
    async removeItem(item, i) {
      await axios.delete("http://localhost:8080/api/foodItems/" + item._id);
    ...
    async updateItem(item, i) {
      const response = await axios.put("http://localhost:8080/api/foodItems/" + item._id, {
